export const FACTORY_ADDRESS = '0x36800286f652dDC9bDcFfEDc4e71FDd207C1d07C'
...
export const SUPPORTED_LIST_URLS__NO_ENS = ['https://tokens.coingecko.com/arbitrum-one/all.json']
